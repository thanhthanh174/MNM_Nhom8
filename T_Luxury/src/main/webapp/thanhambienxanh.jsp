...
<div class="detail-container">
    ...
    <div class="detail-info">
        ...
        <div class="actions">
		    ...
		    <a href="dathang.jsp?name=ThanhAmBienXanh&price=500000&img=707ee0decbc4aed29f872c1598aeaf42.jpg">
		        <button class="btn">Đặt hàng</button>
		    </a>
		
		    <form action="add-to-cart" method="post">
			    <input type="hidden" name="name" value="Thanh Âm Biển Xanh">
			    <input type="hidden" name="price" value="500000">
			    <input type="hidden" name="img" value="707ee0decbc4aed29f872c1598aeaf42.jpg">
...
<div class="description">
    <h3>Mô tả sản phẩm</h3>
   	<p>
	    Bó hoa mang vẻ đẹp sang trọng và cuốn hút với tông xanh dương – trắng làm chủ đạo,
	    gợi lên cảm giác mát lành, sâu lắng như đại dương. Những bông hoa xanh nổi bật với sắc màu
	    chuyển nhẹ tinh tế, cánh hoa mềm mại và nở rộ, tạo nên điểm nhấn đầy nghệ thuật và khác biệt.
	</p>
	
	<p>
	    Xen kẽ giữa sắc xanh là những bông hoa trắng tinh khôi, tượng trưng cho sự thuần khiết và thanh lịch.
	    Sự kết hợp hài hòa giữa hai gam màu này mang đến tổng thể vừa dịu dàng, vừa hiện đại, không quá rực rỡ
	    nhưng lại vô cùng cuốn hút và có chiều sâu.
	</p>
	
	<p>
	    Các loại hoa được sắp xếp đan xen tự nhiên, kết hợp cùng những chi tiết xanh lá và hoa nhỏ,
	    tạo nên bố cục mềm mại và sống động. Bó hoa còn được bao bọc bởi lớp giấy gói mang họa tiết nghệ thuật
	    với tông xanh đậm, góp phần tôn lên vẻ đẹp tổng thể một cách tinh tế.
	</p>
	
	<p>
	    Khi đặt trong không gian như trên xe hay phòng kín, bó hoa vẫn giữ được sự nổi bật riêng,
	    mang lại cảm giác sang trọng và có gu thẩm mỹ cao. Đây là lựa chọn lý tưởng cho những ai yêu thích
	    phong cách tinh tế, hiện đại và có chút cá tính riêng.
	</p>
	
	<p>
	    Không chỉ là một bó hoa, “Dịu Dàng Biển Xanh” còn là biểu tượng của sự bình yên,
	    chiều sâu cảm xúc và những điều nhẹ nhàng nhưng đầy ý nghĩa 💙
	</p>
</div>
