    ...
    <div class="detail-info">
        ...
        <div class="actions">
		    ...
		    <form action="add-to-cart" method="post">
			    <input type="hidden" name="name" value="Lời Thì Thầm">
			    <input type="hidden" name="price" value="200000">
			    <input type="hidden" name="img" value="hoa_cuc_hoa_mi.jpg">
...
<div class="description">
    <h3>Mô tả sản phẩm</h3>
   	<p>
	    Bó hoa mang vẻ đẹp tươi sáng và rực rỡ với những bông cúc họa mi trắng nhỏ xinh,
	    nhụy vàng nổi bật, tạo nên một tổng thể tràn đầy sức sống và năng lượng tích cực.
	    Những bông hoa được sắp xếp dày dặn, phủ kín phần trung tâm, mang lại cảm giác đầy đặn,
	    tự nhiên và vô cùng cuốn hút.
	</p>
	
	<p>
	    Xen kẽ giữa các bông hoa là lớp lá xanh tươi mát, giúp làm nổi bật sắc trắng – vàng
	    của hoa và tạo chiều sâu cho bó. Sự kết hợp này mang lại cảm giác gần gũi với thiên nhiên,
	    nhẹ nhàng nhưng vẫn rất nổi bật và bắt mắt.
	</p>
	
	<p>
	    Phần giấy gói sử dụng tông vàng nâu ấm áp, được xếp lớp khéo léo tạo nên hiệu ứng mềm mại
	    và sang trọng. Lớp nilon trong suốt bên ngoài giúp bảo vệ bó hoa đồng thời làm tăng thêm
	    vẻ hiện đại và tinh tế cho tổng thể thiết kế.
	</p>
	
	<p>
	    Thân bó được buộc bằng ruy băng trắng phối ren nhẹ nhàng, thắt nơ mềm mại và nữ tính,
	    tạo điểm nhấn thanh lịch và hài hòa với tổng thể màu sắc. Chi tiết này góp phần làm cho
	    bó hoa trở nên chỉn chu và tinh tế hơn.
	</p>
	
	<p>
	    Khi đặt trong không gian ấm áp như cửa hàng hay phòng khách, bó hoa càng trở nên nổi bật
	    với sắc màu tươi sáng và rạng rỡ. Đây là lựa chọn hoàn hảo cho các dịp như sinh nhật,
	    chúc mừng, khai trương hoặc đơn giản là một món quà mang lại niềm vui và sự tích cực.
	</p>
	
	<p>
	    Không chỉ là một bó hoa, đây còn là biểu tượng của sự vui tươi, lạc quan và những cảm xúc
	    trong trẻo, giúp bạn gửi gắm thông điệp yêu thương một cách nhẹ nhàng nhưng đầy ý nghĩa 🌼
	</p>
</div>
