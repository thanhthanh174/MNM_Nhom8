<%@ page import="java.util.*, T_Luxury_models.NguoiDung, T_Luxury_dao.NguoiDungDAO" %>
...
<head>
<meta charset="UTF-8">
<title>T Luxury - Người dùng</title>
...
<aside class="sidebar">
    ...
    <ul class="menu">
        ...
        <li><a class="active" href="<%= request.getContextPath() %>/admin/NguoiDung.jsp">👤 Người dùng</a></li>
    </ul>
</aside>
...
<div class="top-bar">
    ...
    <form action="<%= request.getContextPath() %>/NguoiDungServlet" method="get" class="search-box">
    <input type="text" name="keyword" placeholder="🔍 Tìm người dùng...">
    <button type="submit">Tìm</button>
</form>

    <a class="btn-add" href="<%= request.getContextPath() %>/admin/ThemNguoiDung.jsp">
        + Thêm người dùng
    </a>
...
<table>
    ...
    <tr>
        ...
        <td>
            <a class="btn edit"
               href="<%= request.getContextPath() %>/admin/SuaNguoiDung.jsp?id=<%= nd.getId() %>">
                Sửa
            </a>

            <a class="btn delete"
               href="<%= request.getContextPath() %>/admin/XacNhanXoaNguoiDung.jsp?id=<%= nd.getId() %>">
                Xóa
            </a>
        </td>
    </tr>
