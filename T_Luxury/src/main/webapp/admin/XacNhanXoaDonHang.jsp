...
<div class="title">🗑 Xóa đơn hàng</div>

<div class="form-box">

<form action="<%= request.getContextPath() %>/DonHangServlet" method="get">
...
<div class="form-group">
    <label>User ID:</label>
    <input type="number" value="<%= dh.getNguoiDungId() %>" disabled>
</div>

<div class="form-group">
    <label>Tổng tiền:</label>
    <input type="number" value="<%= dh.getTongTien() %>" disabled>
</div>

<div class="form-group">
    <label>Trạng thái:</label>
    <input type="text" value="<%= dh.getTrangThai() %>" disabled>
</div>

<div class="form-group">
    <label>Thanh toán:</label>
    <input type="text" value="<%= dh.getTrangThaiThanhToan() %>" disabled>
</div>

<div class="form-group">
    <label>Phương thức:</label>
    <input type="text" value="<%= dh.getPhuongThucThanhToan() %>" disabled>
</div>

<div class="form-group">
    <label>Tên người gửi:</label>
    <input type="text" value="<%= dh.getTenNguoiGui() %>" disabled>
</div>

<div class="form-group">
    <label>SĐT người gửi:</label>
    <input type="text" value="<%= dh.getSdtNguoiGui() %>" disabled>
</div>

<div class="form-group">
    <label>Tên người nhận:</label>
    <input type="text" value="<%= dh.getTenNguoiNhan() %>" disabled>
</div>

<div class="form-group">
    <label>SĐT người nhận:</label>
    <input type="text" value="<%= dh.getSdtNguoiNhan() %>" disabled>
</div>

<div class="form-group">
    <label>Địa chỉ:</label>
    <input type="text" value="<%= dh.getDiaChiNhan() %>" disabled>
</div>

<div class="form-group">
    <label>Lời nhắn:</label>
    <input type="text" value="<%= dh.getLoiNhan() %>" disabled>
</div>

<div class="form-group">
    <label>Yêu cầu khác:</label>
    <input type="text" value="<%= dh.getYeuCauKhac() %>" disabled>
</div>
