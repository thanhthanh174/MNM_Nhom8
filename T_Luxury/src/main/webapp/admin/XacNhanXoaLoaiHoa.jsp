<%@ page import="T_Luxury_dao.LoaiHoaDAO, T_Luxury_models.LoaiHoa" %>
...
<main class="main-content">
    ...
    <!-- TITLE -->
    <div class="title">Xác nhận xóa loại hoa</div>
    ...
    <div class="form-box">
        ...
        <div class="form-group">
            ...
            <input type="text" value="<%= l.getId() %>" disabled>
        </div>

        <div class="form-group">
            <label>Loại hoa:</label>
            <input type="text" value="<%= l.getTenLoai() %>" disabled>
        </div>
        ...
        <div class="btn-group">
            ...
            <!-- XÓA -->
            <form action="<%= request.getContextPath() %>/LoaiHoaServlet" method="get" style="display:inline;">
