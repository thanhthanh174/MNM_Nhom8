...
<div class="title">🗑 Xóa người dùng</div>

<div class="form-box">

    <p>Bạn có chắc muốn xóa người dùng ID: <b><%= id %></b> không?</p>
    ...
    <div class="btn-group">
        ...
        <!-- XÓA (GIỮ NGUYÊN LINK) -->
        <a href="<%= request.getContextPath() %>/NguoiDungServlet?action=delete&id=<%= id %>">
