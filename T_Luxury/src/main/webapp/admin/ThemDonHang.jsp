...
<div class="title">➕ Thêm đơn hàng</div>
...
<div class="form-group">
    <label>User ID:</label>
    <input type="number" name="nguoiDungId">
</div>
...
<div class="form-group">
    ...
    <input type="text" name="trangThai" value="Cho_xac_nhan">
</div>

<div class="form-group">
    <label>Thanh toán:</label>
    <input type="text" name="trangThaiThanhToan">
</div>
...
<div class="form-group">
    ...
    <input type="text" name="tenNguoiGui">
</div>

<div class="form-group">
    <label>SĐT người gửi:</label>
    <input type="text" name="sdtNguoiGui">
</div>
...
<div class="form-group">
    ...
    <input type="text" name="yeuCauKhac">
</div>
...
<div class="form-group">
    ...
    <input type="text" name="thoiGianGiao">
</div>
