<%@ page import="T_Luxury_dao.NguoiDungDAO, T_Luxury_models.NguoiDung" %>
...
<!-- HEADER -->
    ...
    <div class="title">✏️ Sửa người dùng</div>
    ...
    <input type="text" name="tenDangNhap" value="<%= nd.getTenDangNhap() %>">
</div>

            <div class="form-group">
                <label>Mật khẩu:</label>
                <input type="text" name="matKhau" value="<%= nd.getMatKhau() %>">
            </div>

            <div class="form-group">
                <label>Email:</label>
                <input type="text" name="email" value="<%= nd.getEmail() %>">
            </div>

            <div class="btn-group">
                <a href="<%= request.getContextPath() %>/admin/NguoiDung.jsp">
